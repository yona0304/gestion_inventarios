...
@section('content')
    <div class="p-4 sm:ml-64">
        ...
        <!-- Modal -->
        <div id="detalleModal"
            class="fixed top-0 left-0 z-50 hidden w-full h-full p-4 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm">
            <div
                ...
                <div class="relative">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <p><span class="font-semibold">Identificación:</span> <span id="DeIdentificacion"></span> </p>

...
@section('content')
    <div class="p-4 sm:ml-64">
        ...
        <form id="VehiculoEnvio" action="" method="POST">
            @csrf
            ...
            <button type="submit"
                class="text-white bg-red-900 hover:bg-red-700 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Submit</button>
        </form>

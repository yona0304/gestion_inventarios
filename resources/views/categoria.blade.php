            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-3 md:grid-cols-2">
                <div>
                    <form id="CategoriaEnvio" action="{{ route('categoria.store') }}" method="post"
                        ...
                        @csrf
                        <h2 class="text-center font-semibold leading-7 text-gray-900">Registrar categoria y cantidad</h2>
                        ...
                        <label for="cantidad" class="block text-sm font-medium leading-6 text-gray-900">Cantidad
                        ...
                        <label for="prefijo" class="block text-sm font-medium leading-6 text-gray-900">Prefijo
                            <strong class=" text-red-600">*</strong></label>
                        <div class="mt-2">
